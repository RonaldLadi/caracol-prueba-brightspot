...
🔊 audioPlayer.js – Audio Component

Encapsulates the audio player logic:
...
Manages the hamburger menu:

* Open/closed state toggle
* Class control
* Accessibility attribute handling (`aria-expanded`)
